...
const Services = () => {
  ...
  const heros = [
    ...
    },
    {
      ...
      desc: `<p>Its your day, so you should be the last person to make any adjustments to your design. We provide specific decorations as per the need of our clients. Most of our brides and grooms already have in their mind what they want their day to look like, and we are here to provide it with the designs similar to the most minute details.</p>`
    },
    {
      imageSrc: makeup,
      ...
      desc: `<p>We believe in perfection, makeup is not a layer to hide one's imperfections but to highlight one's features. Your big day is important to us. <br />We offer you with best makeup services, transforming your look and making sure that you looking stunning on your big day and throughout the wedding ceremonies. Artist here understands your requirements and provides you with the makeup that goes along well with your look, making sure that you slay  the day! <br />Services provided - Our services include makeup on venue for the bride and guests,  hairstyling, draping, men's grooming, nail extensions for all occasions.</p>`
    },
    {
      ...
      desc: `<p>Photographs that communicate: Capture those life-cherishing moments with never seen before photography concepts. Make those traditional, candid, bride and groom moments even more rustic, authentic and vivid.</p>`
    },
  ]
            ...
            <section data-aos="fade-up" key={index} className="text-gray-600 body-font">
              <div className={`container mx-auto flex px-8 py-24 ${index % 2 ? "md:flex-row" : "md:flex-row-reverse"} flex-col items-center`}>
                ...
                <div className={`lg:flex-grow md:w-1/2 ${index % 2 ? "lg:pl-24 md:pl-16" : "lg:pr-24 md:pr-16"} flex flex-col md:items-start md:text-left items-center text-center`}>
                  ...
                  <div className="mb-8 leading-relaxed sm:text-xl text-sm" dangerouslySetInnerHTML={{ __html: hero.desc }} />
