              ...
              <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                <div className="px-6 py-12 md:px-12">
                  ...
                  <p className="text-gray-500 mb-6 sm:text-xl text-sm">
                    The roots of regalia diners can be contracted to old Lucknow traditions delivering our services in different sectors of event management such as corporate events, universities, weddings, and railway. Food is something we live, eat, sleep and repeat. As they normally say in India people cannot avoid Weddings and soon, we were found in this trap too. Visiting so many weddings we came across 2 things first, if family or family members are put behind the arrangements of the wedding they are deprived of joyous, blissful, overwhelming, and emotion-rich happening in life, and secondly, if the arrangements are handed to planners, they need not have the same connection with the happening as you share and often it has been observed through the deficiencies lack lustre weddings. Visiting over a century of weddings and observing the missing zing, especially in the food and décor department kind of led to Regalia Diners.
                  </p>
                  <p className="text-gray-500 mb-6 sm:text-xl text-sm">
