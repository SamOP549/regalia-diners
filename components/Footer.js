                ...
                <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-center md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-center typewriter">
                        <Link href='/' className="flex title-font font-medium items-center  justify-center">
                            <Image src='/regalia-logo.png' width={75 * 2} height={67 * 2} alt="footerLogo" />
                        </Link>
                    ...
                    <div className="flex-grow flex flex-wrap -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div className="lg:w-1/4 md:w-1/2 w-full px-3 text-center">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <Link href='/services/catering' className="text-white"><p className='cursor-pointer sm:text-lg text-md'>Menu</p></Link>
                                </li>
                                <li>
                                    <Link href='/services' className="text-white"><p className='cursor-pointer sm:text-lg text-md'>Services</p></Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-3 text-center">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <Link href="tel: +918874247420" className="text-white"><p className='cursor-pointer sm:text-lg text-md'>+91 8874247420</p></Link>
                                </li>
                                <li>
                                    <Link href="mailto: regaliadiners@gmail.com" className="text-white"><p className='cursor-pointer sm:text-lg text-md'>regaliadiners@gmail.com</p></Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-3 text-center">
                ...
                <div className="bg-zinc-900">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row icons-tray">
                        ...
                        <span className="flex space-x-3 sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start icons-tray">
                            ...
                            <a className='hover:scale-125' href='https://www.weddingwire.in/caterers/regalia-diners--e402421' target='_blank' rel="noopener noreferrer"><Image height={39} width={39} className='weddingwire' src={weddingWire} alt='social icon' /></a>
                            <a className='hover:scale-125' href='https://www.wedmegood.com/profile/regalia-diners-2844142' target='_blank' rel="noopener noreferrer"><Image height={39} width={50} className='wedmegood' src={wedlogo} alt='social icon' /></a>
                        </span>
                    </div>
                </div>
            </footer>
